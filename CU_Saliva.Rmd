...
CD_yes_plot<-ggplot(data_CD_yes, aes(x = Time, y = Saliva, colour = ID)) +
  ...
  labs(title = "CD_yes", x="Sample Time",y="Cortisol Level")+
...
CD_no_plot<- ggplot(data_CD_no, aes(x = Time, y = Saliva, colour = ID)) +
  ...
  theme(legend.position = "none") +
  expand_limits(x = range(data_CD_yes$Time))+
  labs(title = "CD_no", x="Sample Time",y="Cortisol Level")+
scale_x_continuous(breaks=c(1,2,3,4,5,6))

ggsave("Plots/CD_no_plot.png", plot = CD_status_plot, width = 8, height = 6, dpi = 300)

spaghetti_plots<-CD_yes_plot+CD_no_plot
ggsave("Plots/spaghetti_plots.png", plot = CD_status_plot, width = 8, height = 6, dpi = 300)
```
...
ggsave("Plots/grouping_plot.png", plot = CD_status_plot, width = 8, height = 6, dpi = 300)
```

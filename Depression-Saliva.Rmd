...
mod <- afex::mixed(Saliva ~ Time*depdxma + (1|ID), data=data_gathered, check_contrasts = FALSE, method="KR") #andrea suggested to add random slopes of time to see how slopes vary.
summary(mod)
